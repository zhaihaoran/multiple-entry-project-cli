...
var Index = function () {
    ...
    _createClass(Index, [{
        ...
        value: function declareVar() {
            ...
            this.$header = (0, _jquery2.default)('nav.tum-header');
        }
    }, {
        key: 'videoPlay',
        ...
        value: function pluginsInit() {
            ...
            this.$animateNumber.each(function (i, el) {
                var aa = (0, _jquery2.default)(el).data('number');
                (0, _jquery2.default)(el).prop('number', 0).animateNumber({
                    number: aa,
                    easing: 'easeOut'
                }, 3000);
            });
...
var xtend = __webpack_require__(21);
...
var vttjs = module.exports = {
  WebVTT: __webpack_require__(23),
  VTTCue: __webpack_require__(24),
  VTTRegion: __webpack_require__(25)
};
